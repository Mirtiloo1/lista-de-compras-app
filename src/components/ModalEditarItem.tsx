...
export default function ModalEditarItem({ visible, onClose, onConfirm, itemAtual } : ModalEditProps) {
    ...
    const formatarInput = (texto: string,) => {
     ...
     useEffect(() => {
        if(visible && itemAtual){
            setNomeItem(itemAtual.nome)
            setQuantidade(itemAtual.quantidade)
            if(itemAtual.preco){
                setValor(itemAtual.preco.toFixed(2).replace('.',','))
            }else{
                setValor('')
            }
        }else{
                ...
                >
                        ...
                        <View style={styles.topModal}>
                            <View style={{ flex: 1 }}>
                                ...
                                <Text style={styles.txtSubtitle}>Edite seu item da lista</Text>
                            </View>
                        ...
                        <TouchableOpacity style={styles.btnCriar} activeOpacity={0.8} onPress={() => onConfirm(nomeItem, quantidade, valor)}>
                            <Text style={styles.txtCriar}>Salvar Alterações</Text>
                        </TouchableOpacity>
