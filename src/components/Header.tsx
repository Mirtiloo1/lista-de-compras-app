...
import { Modal, Pressable, StyleSheet, Text, TextInput, TouchableOpacity, View, Animated, Alert } from "react-native";
...
const Header = forwardRef<HeaderRef, Props>(({ onListaCriada }, ref) => {
    ...
    return(
        <View style={styles.container}>
           ...
           <Modal transparent={true} visible={isModalOpen} onRequestClose={fecharModal}>
            <Animated.View style={[styles.containerModal, { opacity: fadeAnim }]}>
                <Pressable style={StyleSheet.absoluteFill} onPress={fecharModal} />
                <Animated.View style={[styles.contentModal, { transform: [{ translateY: slideAnim }] }]} onStartShouldSetResponder={() => true}>
