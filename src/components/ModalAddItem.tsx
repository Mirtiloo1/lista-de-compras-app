...
export default function ModalAddItem({
  ...
  const paddingSeguro = Math.max(bottomInset + 24, Platform.OS === 'android' ? 64 : 24);
  ...
  useEffect(() => {
    ...
    const showSub = Keyboard.addListener(showEvent, (e) => {
      Animated.timing(keyboardHeight, {
        toValue: (e.endCoordinates?.height ?? 0) + (Platform.OS === 'android' ? 4 : 0),
        ...
        <Animated.View style={{ transform: [{ translateY: slideAnim }] }}>
          ...
          >
            ...
            <View style={styles.topModal}>
              ...
              <TouchableOpacity onPress={onClose} style={styles.fundoClose}>
                <FontAwesome
                  name="close"
                  size={20}
            ...
            <View style={styles.pillContainer}>
              {sugestoes.map((sugestao, index) => (
                <TouchableOpacity
                  ...
                  style={styles.pill}
                  activeOpacity={0.8}
                  onPress={() => setNomeItem(sugestao.nome)}
                >
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.8}
              onPress={() => onConfirm(nomeItem, quantidade, valor)}
            >
